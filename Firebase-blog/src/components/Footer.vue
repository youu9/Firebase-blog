            ...
            <div class="col-1">
                <router-link class="header" :to="{ name: 'home' }">CyBlogs</router-link>
                    <ul>
                        ...
                        <li>
                            <a href="#"><twitter class="svg-icon"></twitter></a>
                        </li>
                        <li>
                            <a href="#"><instagram class="svg-icon"></instagram></a>
                        </li>
                        <li>
                            <a href="#"><linkedin class="svg-icon"></linkedin></a>
                        </li>
                    </ul>
            </div>
            <div class="col-2">
                <ul>
                    ...
                    <router-link  v-if="!user" class="link">Login In / Register</router-link>
                </ul>
            </div>
        </div>
        <div class="right">
